...
int CompareByHour(const void *p, const void *q);
int CompareByDate(const void *t, const void *w);
int CompareDestCode(const void * a, const void * b);
int CompareBySourceCode(const void * a, const void * b);
